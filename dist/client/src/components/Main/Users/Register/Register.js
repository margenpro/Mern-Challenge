...
function Register() {
    ...
    const [passwordCheck, setPasswordCheck] = react_1.useState();
    ...
    const submit = (e) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield axios_1.default.post("http://localhost:5000/users/register", newUser);
            const loginResponse = yield axios_1.default.post("http://localhost:5000/users/login", {
                email,
                password,
            });
            setUserData({
    ...
    return (react_1.default.createElement("div", { className: "bg1 font" },
        ...
        react_1.default.createElement(react_bootstrap_1.Form, { onSubmit: submit },
            ...
            react_1.default.createElement(react_bootstrap_1.Form.Control, { className: password === passwordCheck
                    ? "form-control"
                    : "is-invalid form-control", type: "password", placeholder: "Confirm password", onChange: (e) => setPasswordCheck(e.target.value) }),
            react_1.default.createElement(react_bootstrap_1.Form.Label, null, "First Name "),
            react_1.default.createElement(react_bootstrap_1.Form.Control, { type: "text", id: "firstName", onChange: (e) => setFirstName(e.target.value) }),
            react_1.default.createElement(react_bootstrap_1.Form.Label, null, "Last Name "),
            react_1.default.createElement(react_bootstrap_1.Form.Control, { type: "text", id: "lastName", onChange: (e) => setLastName(e.target.value) }),
            react_1.default.createElement(react_bootstrap_1.Form.Label, null, "DNI "),
            react_1.default.createElement(react_bootstrap_1.Form.Control, { type: "text", id: "dni", onChange: (e) => setDni(e.target.value) }),
            react_1.default.createElement(react_bootstrap_1.Button, { variant: "primary", type: "submit", disabled: !checkFields }, "Register"))));
}
